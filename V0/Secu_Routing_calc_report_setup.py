...
from openpyxl.styles import Font, Border, Side, NamedStyle, Alignment, PatternFill
...
def process_data(csv_file_path, excel_path):
    ...
    # Prompt the user to specify the Excel file to save
...
def main():
    ...
    Label(root, text="Generate Report", font=("Arial", 16)).pack(pady=10)
    
    Button(root, text="Select CSV File", command=lambda: process_data(select_file(), save_file())).pack(pady=10)
